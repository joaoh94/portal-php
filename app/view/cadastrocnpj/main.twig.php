    ...
    <form class="form-horizontal">
        <fieldset>
            <div class="panel panel-primary">
                <div class="panel-heading">Cadastro para Cliente CNPJ</div>
...
<div class="col-md-4 control-label">
    ...
    -->
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="Nome">Razão Social <h11>*</h11></label>
                        <div class="col-md-8">
                            <input id="razaosocial" name="razaosocial" placeholder="" class="form-control input-md" required="" type="text">
                        </div>
                    </div>

                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="Nome">Nome Fantasia <h11>*</h11></label>
                        <div class="col-md-8">
                            <input id="nomefantasia" name="nomefantasia" placeholder="" class="form-control input-md" required="" type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input id="cnpj" name="cnpj" placeholder="Apenas números" class="form-control input-md" required="" type="text" maxlength="11" pattern="[0-9]+$">
                        </div>

                        <label class="col-md-2 control-label" for="inscestadual">Insc. Estadual <h11>*</h11></label>
                        <div class="col-md-2">
                            <input id="inscestadual" name="inscestadual" placeholder="Apenas números" class="form-control input-md" required="" type="text" maxlength="11" pattern="[0-9]+$">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-1 control-label" for="prependedtext">FAX</label>
                        <div class="col-md-2">
                            <div class="input-group">
                    ...
                    <!-- Prepended text-->
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="prependedtext">Logradouro <h11>*</h11></label>
                        <div class="col-md-5">
                            <div class="input-group">
                                <span class="input-group-addon">Logradouro</span>
                                <input id="prependedtext" name="prependedtext" class="form-control" placeholder="" required="" type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="newpost">
                        ...
                        <!-- Text input-->
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="vinculo">Vinculo empregatício (cargo)<h11>*</h11></label>
                            <div class="col-md-2">
    ...
    <option value=""></option>
      ...
      <option value="Superior Completo">Superior Completo</option>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-1 control-label" for="prependedtext">Email Pessoal<h11>*</h11></label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                    <input id="prependedtext" name="prependedtext" class="form-control" placeholder="email@email.com" required="" type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
